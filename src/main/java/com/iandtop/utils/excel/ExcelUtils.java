...
public class ExcelUtils<E> {
    ...
    private static Workbook getBeyondWorkbook(String filePath) throws IOException {
    ...
    public static void writeToFile(String filePath, String[] sheetName, List<? extends Object[]> title, List<? extends List<? extends Object[]>> data) throws FileNotFoundException, IOException {
        // 创建并获取工作簿对象
        Workbook wb = getWorkBook(filePath, sheetName, title, data);
        // 写入到文件
     ...
     * @throws IOException           IO异常
     */
    public static Workbook getWorkBook(String filePath, String[] sheetName, List<? extends Object[]> title, List<? extends List<? extends Object[]>> data) throws FileNotFoundException, IOException {

        // 创建工作簿
        //Workbook wb = new SXSSFWorkbook();
        Workbook wb = getBeyondWorkbook(filePath);
        // 创建一个工作表sheet
        Sheet sheet = null;
        // 申明行
        Row row = null;
    ...
    public static <T> void writeToFile(List<T> list, ExcelDataFormatter edf, String filePath) throws Exception {
        // 创建并获取工作簿对象
        Workbook wb = getWorkBook(filePath, list, edf);
        // 写入到文件
        FileOutputStream out = new FileOutputStream(filePath);
        wb.write(out);
        out.close();
     ...
     * @throws Exception
     */
    public static <T> Workbook getWorkBook(String filePath, List<T> list, ExcelDataFormatter edf) throws Exception {
        // 创建工作簿
        // Workbook wb = new SXSSFWorkbook();
        Workbook wb = getBeyondWorkbook(filePath);
...
//        Field[] fields = ReflectUtils.getClassFieldsAndSuperClassFields(e.getClass());
        ...
        Workbook wb = getBeyondWorkbook(file.getPath());
...
//         writeToFile(list,edf, "D:\\x.xlsx");
        ...
        System.out.println(JSONArray.toJSON(xx));
